...
export const DEFAULT_ROLE_PERMISSIONS: Record<string, string[]> = {
  admin:    ["dashboard", "employees", "departments", "attendance", "leaves", "users", "roles", "salary", "expenses", "profile", "settings"],
  hr:       ["dashboard", "employees", "departments", "attendance", "leaves", "profile"],
  employee: ["dashboard", "attendance", "leaves", "profile"],
  manager:  ["dashboard", "employees", "departments", "attendance", "leaves", "profile"],
};
